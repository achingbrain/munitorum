...
export default {
  translation: {
    ...
    'too-many-lords-of-war': 'Too many points have been spent on Lords of War',
    ...
    'not-enough-daemon-hordes': 'For each Daemonic Horde detachment taken, one Follower of Chaos detachment (of the same god affiliation or undivided) may be selected.',
    'greater-daemons-require-patron-hordes': 'Greater Daemon Hordes require a Daemonic Horde from the same Patron God to be present',
    ...
    'daemonic-hordes-chaos-fury-flight': 'Fury Flight',
    'daemonic-hordes-chaos-fury-flight-unit': 'Chaos Furies',
    'daemonic-hordes-chaos-spawn-pack': 'Chaos Spawn Pack',
    'daemonic-hordes-chaos-fury': 'Chaos Furies',
    'daemonic-hordes-chaos-spawn': 'Chaos Spawn',
    'daemonic-hordes-chaos-spawn-pack-unit': 'Chaos Spawn',
    'daemonic-hordes-soul-grinder-maniple': 'SoulGrinder Maniple',
    'daemonic-hordes-soul-grinder': 'Soul Grinder',
    'daemonic-hordes-soul-grinder-maniple-unit': 'Soul Grinder',
